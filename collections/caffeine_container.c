...
static cff_err_e cff_container_get_item(cff_container_s *container,
                                        uint64_t index, uintptr_t out) {
  return cff_container_get(*container, index, out);
}

static bool cff_container_get_item_ref(cff_container_s *container,
                                       uint64_t index, uintptr_t *out) {
  return cff_container_get_ref(*container, index, out);
}

static cff_err_e cff_container_add_item(cff_container_s *container,
                                        uint64_t index, uintptr_t in,
                                        cff_allocator_t allocator) {
  return cff_container_insert(*container, index, in);
}

static cff_err_e cff_container_remove_item(cff_container_s *container,
                                           uint64_t index,
                                           cff_allocator_t allocator) {
