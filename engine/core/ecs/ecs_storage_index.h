...
void ecs_storage_index_new_storage(storage_index *const index, archetype_id arch_id, const component_id *const components, const size_t *const sizes, const char **const names_owning, uint32_t lenght);
