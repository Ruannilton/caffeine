...
#include "../collections/caffeine_hashmap.h"
#include "../collections/caffeine_vector.h"
#include "../core/caffeine_string.h"
...
// component
CAFF_API component_id ecs_register_component(ecs_world *world, cff_string name,
                                             cff_size size);
CAFF_API component_id ecs_get_component_id_from_name(ecs_world *world,
                                                     cff_string name);
CAFF_API ecs_component_info ecs_get_component_info(ecs_world *world,
                                                   component_id id);
